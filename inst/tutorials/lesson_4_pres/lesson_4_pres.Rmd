...
```{r gapminder_year_filter, exercise.setup='gapminder_setup', exercise=TRUE}
...
```{r gapminder_multiple_filter, exercise.setup='gapminder_setup', exercise=TRUE}
gapminder %>% 
...
```{r gapminder_or_filter, exercise.setup='gapminder_setup', exercise=TRUE}
gapminder %>% 
  filter(year == 2002 | continent == "Asia") %>% 
  sample_n(4)
```
...
```{r gapminder_membership_filter, exercise.setup='gapminder_setup', exercise=TRUE}
gapminder %>% 
...
```{r gapminder_select, exercise.setup='gapminder_setup', exercise=TRUE}
gapminder %>% 
...
```{r gapminder_rename, exercise.setup='gapminder_setup', exercise=TRUE}
gapminder %>% 
...
```{r gapminder_arrange, exercise.setup='gapminder_setup', exercise=TRUE}
gapminder %>% 
  arrange(year) %>% 
  head(4)
```
...
```{r gapminder_arrange_multiple, exercise.setup='gapminder_setup', exercise=TRUE}
gapminder %>% 
...
```{r gapminder_desc_arrange, exercise.setup='gapminder_setup', exercise=TRUE}
gapminder %>%
  filter(year > 2000) %>%
...
```{r gapminder_mutate, exercise.setup='gapminder_setup', exercise=TRUE}
gapminder %>% 
  mutate(just_one = 1) %>% 
  head(4)
```
...
```{r gapminder_mutate_arithmetic, exercise.setup='gapminder_setup', exercise=TRUE}
gapminder %>%
...
```{r gapminder_mutate_change_var, exercise.setup='gapminder_setup', exercise=TRUE}
gapminder %>%
  mutate(pop = pop/1e6) %>% 
  head(4)
```
...
```{r gapminder_summarize, exercise.setup='gapminder_setup', exercise=TRUE}
gapminder %>% 
  filter(year == 1997) %>% 
...
```{r gapminder_groupby, exercise.setup='gapminder_setup', exercise=TRUE}
gapminder %>% 
  filter(year == 1997) %>% 
  group_by(continent) %>%
  summarize(max_exp = max(lifeExp),
...
```{r gapminder_groupby_multiple, exercise.setup='gapminder_setup', exercise=TRUE}
gapminder %>% 
